...
<h1 class="heading"> <span>vaccine </span> report </h1>    
    ...
    <div class="row">
        ...
        ?>
            ...
            <input type="number"name="number" placeholder="patient number" class="box">
            <input type="number"name="age" placeholder="patient age" class="box">
            <input type="date"name="date" placeholder="patient vaccine date" class="box">
